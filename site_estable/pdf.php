            ...
            <table align="right">
                ...
                <tr>
                    <td align="right">
                        ...
                        <span class="palid-text text-right">'.$fechaFactura . ' ' . date('H:i:s').'</span>
                    </td>
                </tr>
            </table>
    </div>
...
<div class="row" style="margin-top:20px;">
    <div class="col-xs-5">
        ...
        '.$gnu['nombre_gnu'].'<br>
        GNU020927CUA<br>
        '.$gnu['calle_gnu'].' No. '.$gnu['numero_gnu'].'<br>
        '.$gnu['colonia_gnu'].'<br>
        '.$gnu['cp_gnu'].'<br>
        '.$gnu['municipio_gnu'].','.$gnu['estado_gnu'].'<br>

        R.F.C.: '.$gnu['rfc_gnu'].'<br>
        </div>
    </div>
...
<div class="row">
    <div style="padding:10px;"> 
        ...
        <table style="width: 99%">
            ...
            foreach ($idSale as $key2) {
                $url = "http://gnuvehicular.mine.nu:8580/ventas_general.php?idventas=$key2";
                $ch = curl_init();
                ...
                $total += $array['rows'][1]['total'];
                $volumen = $array['rows'][1]['volumen'];
                $precioPorUnidad = $array['rows'][1]['precioUnitario'];
                $subtotal = number_format($array['rows'][1]['subtotal'], 2);
...
$mpdf->Output('facturas-gnu/factura_' . $idFolioFactura . '.pdf', 'F');
