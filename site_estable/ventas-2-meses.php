        ...
        <div class="main-body">
            <div class="container col-md-push-2 col-md-8" id="home">
                ...
                <div class="content">
                    ...
                    //-- First cross domain
                        $url = "http://gnuvehicular.mine.nu:8580/ventas_2meses.php?operation=$operation&billOperation=$billOperation";
                        $ch = curl_init();
                    ...
                    <ul class="nav nav-tabs bottom" role="tablist">
                        <li><a href="index.php" class="size-menu"> <i class="fa fa-calendar"></i> Ventas de 1 mes</a></li>
